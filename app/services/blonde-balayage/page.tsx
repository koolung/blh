...
export default function BlondeBalayageService() {
  return (
    <main className="min-h-screen bg-[#FECD8C]">
      ...
      <section 
        ...
        style={{ backgroundImage: 'url(/images/services/blonde-balayage.gif)' }}
      >
        ...
        <div className="relative max-w-4xl z-10 text-left">
          ...
          >
            Beautiful blonde balayage with dimensional tones
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="bg-[#001317] p-3 pt-4 pb-4 rounded-2xl shadow-lg text-center">
              ...
              <p className="text-2xl font-bold text-[white]">from $240</p>
            </div>
          ...
          >
            ...
            <p className="text-lg text-[white] mb-4 leading-relaxed">
              Blonde Balayage is the perfect choice for those seeking multi-dimensional blonde tones with a natural finish. This hand-painted technique combines warm and cool blonde shades to create depth, movement, and a beautifully luminous result.
            </p>
            <p className="text-lg text-[white] mb-4 leading-relaxed">
              Our expert colorists strategically place various blonde tones throughout your hair to create a dimensional, lived-in look. The result is a stunning blend of colors that adds volume and movement to your hair while maintaining a natural appearance.
            </p>
            <div className="grid md:grid-cols-2 gap-8 mt-8">
              <div>
                <h3 className="text-xl font-bold text-[#FECD8C] mb-4">Benefits</h3>
                <ul className="space-y-3">
                  {['Multi-dimensional blonde shades', 'Creates a natural, lived-in look', 'Adds apparent volume and movement', 'Flatters all hair types', 'Blends with your natural hair', 'Less damaging than all-over color'].map((benefit) => (
              ...
              <div>
                ...
                <ul className="space-y-3 text-[white]">
                  <li><strong>Consultation:</strong> Discuss blonde shade placement and dimension</li>
                  <li><strong>Color Selection:</strong> Choose from warm and cool blonde tones</li>
                  <li><strong>Hand-Painting:</strong> Expert application of highlights throughout</li>
                  <li><strong>Styling:</strong> Professional styling to showcase all the dimension</li>
                </ul>
              </div>
            </div>
          </motion.div>
