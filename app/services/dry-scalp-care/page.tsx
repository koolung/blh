...
export default function DryScalpCareService() {
  return (
    <main className="min-h-screen bg-[#FECD8C]">
      ...
      <section 
        ...
        style={{ backgroundImage: 'url(/images/services/dry-scalp-care.gif)' }}
      >
        ...
        <div className="relative max-w-4xl z-10 text-left">
          ...
          >
            Specialized treatment to soothe and nourish dry, flaky scalp
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-[white] mb-4 leading-relaxed">
              If you're struggling with a dry, itchy, or flaky scalp, our Dry Scalp Care treatment is designed specifically to address your needs. This specialized treatment uses nourishing oils and therapeutic techniques to restore balance and comfort to your scalp.
            </p>
            <p className="text-lg text-[white] mb-4 leading-relaxed">
              Our certified technicians will assess your scalp condition and apply targeted treatments to soothe irritation, reduce flakiness, and deeply nourish your scalp. The result is a healthier, more comfortable scalp and better-looking hair.
            </p>
            <div className="grid md:grid-cols-2 gap-8 mt-8">
              <div>
                <h3 className="text-xl font-bold text-[#FECD8C] mb-4">Benefits</h3>
                <ul className="space-y-3">
                  {['Soothes itchy scalp', 'Reduces flakiness', 'Deep nourishment', 'Promotes hair health', 'Improves hair appearance', 'Relaxing experience'].map((benefit) => (
              ...
              <div>
                ...
                <ul className="space-y-3 text-[white]">
                  <li><strong>Scalp Analysis:</strong> Assessment of your scalp condition</li>
                  <li><strong>Cleansing:</strong> Gentle cleansing to remove buildup</li>
                  <li><strong>Treatment Application:</strong> Nourishing oils and therapies</li>
                  <li><strong>Relaxation:</strong> Therapeutic massage to ease tension</li>
                </ul>
              </div>
            </div>
          </motion.div>
